			        ...
			        <form method="get" action="">
			        	...
			        	<?php 
			        		$payment_channels = array(
			        				...
			        				['label'=>'Bank Transfer','id'=>'05','icon'=>asset("vendor/dokularavel/logo_atmbersama.jpg")]
			        			);
			        	...
			        	?>
					        		...
					        		<a href='{{url(config("dokularavel.PAYMENT_PATH"))."?trans_id=".Request::get("trans_id")."&payment_channel=".$payment_channel["id"]}}' class='payment_channel'> {{$payment_channel['label']}} 
					        			<span class='pull-right'><img style="margin-top: -2px" src='{{asset("vendor/dokularavel/ic_arrow_right.png")}}'/></span>
					        		</a>
